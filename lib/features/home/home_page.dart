...
class _HomePageState extends State<HomePage> {
  ...
  List<TrendingProducts> _getProducts() {
    final optionItems = <TrendingProducts>[];
    return optionItems;
  }
  ...
  void initState() {
    super.initState();
    getCartData();
    optionItems.add(TrendingProducts('1',
      'Peanut Butter',
    ...
    optionItems.add(TrendingProducts('2',
        'Vegetable base',
    ...
    optionItems.add(TrendingProducts('3',
    ...
    optionItems.add(TrendingProducts('4',
        'Raw Honey',
    ...
    optionItems.add(TrendingProducts('5',
        'Vega Choclate',
    ...
    optionItems.add(TrendingProducts('6',
        'Olive Oil',
    ...
    optionItems.add(TrendingProducts('7',
        'Palm Sugar',
    ...
    optionItems.add(TrendingProducts('8',
        'Probiotic Yogurt',
    ...
    optionItems.add(TrendingProducts('9',
        'Oat Meal',
    ...
    optionItems.add(TrendingProducts('10',
        'Amla Powder',
    ...
    optionItems.add(TrendingProducts('11',
        'Raw Cacao Butter',
    ...
    optionItems.add(TrendingProducts('12',
        'Oats Granola',
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      ...
      appBar: mainAppBar('HomePage',() => Navigator.of(context).push(
        MaterialPageRoute(
          builder: (context) => CartPage(cartList: _cart,optionItems: optionItems)
        ),
      ),_cart.length),
                    ...
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (context) => ProductDetail(
                            ...
                            optionItems[index].price,optionItems[index].desc,optionItems[index].spec),
                      ),
                    );
                  },
                  child: Column(
                              ...
                              Align(
                                ...
                                child: Container(
                                  ...
                                  child: OutlinedButton(
                                    onPressed: () async {
                                      _addToCart(optionItems[index].id);
                                    ...
                                    style: OutlinedButton.styleFrom(
                                      ...
                                      side: BorderSide(
                                          width: 0.7, color: greenButtonColor),
                                    ),
                                  ),
                                ),
                              ),
